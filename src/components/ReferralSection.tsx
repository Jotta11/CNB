...
import { Handshake, ArrowRight, TrendingUp, Users, Lock } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            {/* Botão bloqueado — Em Breve */}
            <button
              disabled
              className="inline-flex items-center gap-3 bg-accent text-white font-display text-xl tracking-widest px-8 py-4 rounded-full opacity-80 cursor-not-allowed select-none shadow-lg shadow-accent/30"
            >
