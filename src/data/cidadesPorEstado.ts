export const cidadesPorEstado: Record<string, string[]> = {
  'Acre': [
    ...
    'Brasiléia', 'Senador Guiomard', 'Plácido de Castro', 'Xapuri', 'Epitaciolândia'
  ],
  'Alagoas': [
  ...
  'Amapá': [
    ...
    'Porto Grande', 'Tartarugalzinho', 'Pedra Branca do Amapari', 'Vitória do Jari', 'Calçoene'
  ],
  'Amazonas': [
  ...
  'Bahia': [
    ...
    'Barreiras', 'Alagoinhas', 'Porto Seguro', 'Luís Eduardo Magalhães', 'Eunápolis'
  ],
  'Ceará': [
  ...
  'Distrito Federal': [
    ...
    'Planaltina', 'Águas Claras', 'Recanto das Emas', 'Gama', 'Guará'
  ],
  'Espírito Santo': [
  ...
  'Mato Grosso': [
    ...
    'Campo Novo do Parecis', 'Colíder', 'Guarantã do Norte', 'Juara', 'Sapezal'
  ],
  'Mato Grosso do Sul': [
    'Campo Grande', 'Dourados', 'Três Lagoas', 'Corumbá', 'Ponta Porã',
    'Naviraí', 'Nova Andradina', 'Aquidauana', 'Sidrolândia', 'Paranaíba',
    'Maracaju', 'Coxim', 'Chapadão do Sul', 'Rio Brilhante', 'Cassilândia'
  ],
  'Minas Gerais': [
    ...
    'Pouso Alegre', 'Teófilo Otoni', 'Barbacena', 'Sabará', 'Varginha'
  ],
  'Pará': [
    'Belém', 'Ananindeua', 'Santarém', 'Marabá', 'Parauapebas',
    'Castanhal', 'Abaetetuba', 'Cametá', 'Marituba', 'Bragança',
    'Altamira', 'Tucuruí', 'Redenção', 'Paragominas', 'Itaituba'
  ],
  'Paraíba': [
  ...
  'Piauí': [
    ...
    'Bom Jesus', 'Uruçuí', 'Corrente', 'São Raimundo Nonato', 'Oeiras'
  ],
  'Rio de Janeiro': [
  ...
  'Rondônia': [
    ...
    'Buritis', 'Nova Mamoré', 'Machadinho do Oeste', 'Espigão do Oeste', 'Colorado do Oeste'
  ],
  'Roraima': [
...
export const estados = Object.keys(cidadesPorEstado).sort();
